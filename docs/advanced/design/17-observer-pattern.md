...
<center>
    <img src="../../../docs/.vuepress/public/design/observer_mode.png" style="zoom:150%;" /><br>
...
### 2. 具体事件监听者（观察者） EmailListener.java、SmsListener.java 
